...
$nombredelcurso = "Peluquería para Perros";
...
// descripcion
$des = "Fabio Gomez Sepulveda te enseñará todo sobre estética y peluquería para perros desde nivel básico a avanzado. Apresúrate que cerramos inscripciones pronto - Petz School.";

// titulo
$tit = "✓ Aprende desde cero todo sobre estética y Peluquería para Perros y crea tu Propio Negocio - Petz School - Fabio Gomez Sepulveda";
...
$linkProducto = "https://go.hotmart.com/N43077090C?ap=28d2";
		...
		<section id="first-scroll" <?php if (!$timer) echo "class='hasMenu'" ?> aria-labelledby="first-scroll-heading" itemscope itemtype="https://schema.org/EducationalOccupationalProgram">
			<div class="container back1080">
				...
				<h1 id="first-scroll-heading" itemprop="name">
					Aprende desde cero todo sobre estética y <b>Peluquería para Perros</b> y crea tu Propio Negocio
				</h1>
