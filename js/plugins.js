...
function createBullets() {
    for (var a = 0; a < numOfSlides + 1; a++) {
        ...
        b.addClass("slider-pagi__elem-" + a).data("page", a),
        a || b.addClass("active"),
        $pagination.append(b)
    }
}
function manageControls() {
    ...
    curSlide || $(".slider-control.left").addClass("inactive"),
    curSlide === numOfSlides && $(".slider-control.right").addClass("inactive")
}
function autoSlide() {
...
function changeSlides(a) {
    ...
    $slideBGs.css("transform", "translate3d(" + 50 * curSlide + "%,0,0)"),
    diff = 0,
    autoSlide()
}
function navigateLeft() {
    animating || (curSlide > 0 && curSlide--,
    changeSlides())
}
function navigateRight() {
    animating || (curSlide < numOfSlides && curSlide++,
    changeSlides())
}
var $slider = $(".slider"), $slideBGs = $(".slide__bg"), diff = 0, curSlide = 0, numOfSlides = $(".slide").length - 1, animating = !1, animTime = 500, autoSlideTimeout, autoSlideDelay = 6e3, $pagination = $(".slider-pagi");
createBullets(),
autoSlide(),
$(document).on("mousedown touchstart", ".slider", function(a) {
    if (!animating) {
        window.clearTimeout(autoSlideTimeout);
        var b = a.pageX || a.originalEvent.touches[0].pageX
          , c = $(window).width();
        diff = 0,
        $(document).on("mousemove touchmove", function(a) {
            var d = a.pageX || a.originalEvent.touches[0].pageX;
            diff = (b - d) / c * 70,
            (!curSlide && diff < 0 || curSlide === numOfSlides && diff > 0) && (diff /= 2),
...
$(document).on("mouseup touchend", function(a) {
    if ($(document).off("mousemove touchmove"),
    !animating) {
        if (!diff)
...
!function($) {
    ...
    $.fn.rollerInit = function() {
        ...
        $(".numscroller").each(function() {
            a++,
            $(this).attr("data-slno", a),
            $(this).addClass("roller-title-number-" + a)
        })
    }
    ,
    $.fn.scrollzip = function(a) {
        ...
        return this.each(function(a, c) {
            ...
            $.isFunction(b.showFunction) && !$(this).hasClass("isShown") && $(window).outerHeight() - b.showShift > $(this).offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) && $("#scrollzipPoint").offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) < $(this).outerHeight() + $(this).offset().top - b.showShift && ($(this).addClass("isShown"),
            b.showFunction.call(this)),
            $.isFunction(b.hideFunction) && $(this).hasClass("isShown") && ($(window).outerHeight() - b.hideShift < $(this).offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) || $("#scrollzipPoint").offset().top + (b.wholeVisible ? $(this).outerHeight() : 0) > $(this).outerHeight() + $(this).offset().top - b.hideShift) && ($(this).removeClass("isShown"),
            b.hideFunction.call(this)),
            this
        })
    }
}(jQuery);
