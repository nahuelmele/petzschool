...
$base = "../../";
$dirLanding = "dieta-cocinada-para-perros";
$nombredelcurso = "Dieta cocinada para perros";
$autor = "Diana Fonseca";
...
<html lang="es-ES">
    ...
    <body id="page-top" class="<?= $dirLanding ?>" >
        ...
        $masBeneficios = [
            "Más de 20 lecciones en video, formato súper HD.",
				...
				<div id="owl-reviews">
					...
					$carouselTestimoniosItems = [
						...
						[
							"nombre" => "Sandra Muñoz",
							"bajada" => "Dog Lover",
							"descripcion" => "Me encanto el curso de Dieta cocinada para perros, mi perro se llama rocky y prepararle deliciosos snack es una excelente actividad que la disfruto con mi hijo. Amamos a Rocky y el ama estas recetas…… Muchisimas Gracias Diana!!!!",
						...
						[
							...
							"bajada" => "Cat Lover",
							"descripcion" => "Maya celebró su 3er cumpleaños con una torta de atún que realizamos con el curso de Dieta cocinada para perros de la profe Diana. Realizare luego helados para Maya que estan en el curso espero me queden delicioso como esta torta.",
