...
$base = "../../";
$dirLanding = "tecnicas-de-decoracion-pasteleria";
			...
			<div id="temario" class="two-cols">
			  <div class="active">
				...
				<ul itemprop="hasCourseInstance" itemscope itemtype="https://schema.org/CourseInstance">
					...
					<li itemprop="courseMode" content="online"><span>Clase No 4.</span> – Receta de galletas de pavo y manzana verde.</li>
					<li itemprop="courseMode" content="online"><span>Clase No 5.</span> – Modelado de galleta Beagle.</li>
					<li itemprop="courseMode" content="online"><span>Clase No 6.</span> – Modelado de galleta gato.</li>
					<li itemprop="courseMode" content="online"><span>Clase No 7.</span> – Modelado de galleta Yorkie.</li>
					<li itemprop="courseMode" content="online"><span>Clase No 8.</span> – Modelado de galleta Border Collie.</li>
					<li itemprop="courseMode" content="online"><span>Clase No 9.</span> – Técnica de pintura sobre galleta.</li>
					<li itemprop="courseMode" content="online"><span>Módulo 3 – FACECAKE </span></li> 

					<li itemprop="courseMode" content="online"><span>Clase No 10.</span> – Tecinas de decoracion Pasteleria canina y felina.</li>
				...
				<div id="owl-reviews">
					...
					$carouselTestimoniosItems = [
						...
						[
							"nombre" => "Sandra Muñoz",
							"bajada" => "Dog Lover",
							"descripcion" => "Me encanto el curso de Técnicas de decoración Pastelería canina y felina, mi perro se llama rocky y prepararle deliciosos snack es una excelente actividad que la disfruto con mi hijo. Amamos a Rocky y el ama estas recetas…… Muchisimas Gracias Diana!!!!",
						...
						[
							...
							"bajada" => "Cat Lover",
							"descripcion" => "Maya celebró su 3er cumpleaños con una torta de atún que realizamos con el curso de Técnicas de decoración Pastelería canina y felina de la profe Diana. Realizare luego helados para Maya que estan en el curso espero me queden delicioso como esta torta.",
