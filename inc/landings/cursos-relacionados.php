<section id="cursos-relacionados" class="bgYellow" aria-labelledby="cursos-relacionados-heading">

	<div class="section-heading text-center">

        <?php if (!empty($cursosRelacionados['title'])) { ?>

        <h2 id="cursos-relacionados-heading"><?= $cursosRelacionados['title'] ?></h2>

        <?php } ?>

	</div>

    <div id="owl-cursos-relacionados" class="owl-carousel" itemscope itemtype="https://schema.org/ImageGallery">
